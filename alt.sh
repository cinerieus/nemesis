...
sudo apt install -y build-essential clang flex bison g++ gawk gcc-multilib g++-multilib gettext libncurses5-dev libssl-dev python3-distutils rsync unzip zlib1g-dev file fish neovim tmux git curl wget socat python3 python3-pip p7zip tmux cifs-utils
